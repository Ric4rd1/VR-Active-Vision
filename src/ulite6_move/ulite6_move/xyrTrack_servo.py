...
class xyrTrack(Node):
    def __init__(self):
        super().__init__('xyrtrack_servo')
        self.get_logger().info('xyrtrack servo initialized')
    ...
    def pose_callback(self, msg):
        ...
        #self.get_logger().info(f"Moving to XY = {target_pose[0]:.1f}X {target_pose[1]:.1f}Y mm")
