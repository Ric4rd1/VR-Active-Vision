...
The VR headset (HMD) controls the perspective of the camera mounted on the robotic arm, enabling an **active vision system**.  
...
- **Unity** connected to **ROS 2** using the [ROS–TCP–Connector](https://github.com/Unity-Technologies/Unity-Robotics-Hub). 
- **ROS2 Humble**
